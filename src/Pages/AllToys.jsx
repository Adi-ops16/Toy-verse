        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-8 py-10 px-4 lg:px-8 bg-[#FFF9EC]">
            ...
            <section className="md:col-span-3 lg:col-span-5 space-y-6">
                <div className="flex flex-wrap items-center justify-between border-b-2 border-[#E1AD01]/60 pb-3">
                    ...
                    <div>
                        <label className="input focus-within:outline-0 focus-within:shadow-xl focus-within:border-2 border-[1.5px] rounded-xl border-[#5b3f2c] bg-[#FFF9EC]">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-7">
                    {loading ? (
                        ...
                        searchedToys.length === 0 ?
                            <div className='col-span-3 flex justify-center items-center min-h-96'>
                                <h2 className='text-4xl font-bold text-[#5b3f2c]'>Opps!! No toys found</h2>
                            </div>
                            :
