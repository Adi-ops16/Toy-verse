        ...
        <section className="my-5 lg:my-20">
            ...
            <div className="flex flex-wrap justify-center gap-6">
                {achievements.map((a, i) => (
                    <div
                        key={i}
                        className="bg-linear-to-b from-[#FFFBEA] to-[#FFF4D2] hover:from-[#FFF7E0] hover:to-[#FFE9A0] border border-[#FFE5A0]/50 rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 p-8 flex flex-col items-center text-center"
                    >
